				...
				<div class="panel panel-flat">
					...
					<div class="panel-body">
						<div class="table-responsive">
							<form action="kelola_skripsi_act.php" method="post" enctype="multipart/form-data" >
								
								<?php
								$id = $_GET['id'];
								$data = mysqli_query($connect,"SELECT * FROM tbl_skripsi WHERE id='$id'");		
								while($d=mysqli_fetch_array($data)){
									...
									<th width="20%">Skripsi</th>

									
									<td>
											<?php echo $d['nama_file']; ?> 
										
											<?php echo"<a class='btn btn-success' href='../skripsi/$d[nama_file]'>"?>Lihat</i></a>
											</td>		
									</tr>
