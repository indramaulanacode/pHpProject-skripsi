...
<body>
	...
	<div class="container">
		<h2 style="text-align: center;">Upload Skripsi</h2>
		<form action="ajukan_skripsi_act.php" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label>Skripsi :</label>
				<input type="file" name="skripsi" required="required">
