...
<head>
  ...
  <title>Aplikasi Manajemen Tugas Skripsi. Login Dosen</title>
    ...
    <div class="page-content">
      ...
      <div class="content-wrapper">
        ...
        <div class="content">
          ...
          <!-- Advanced login -->         
          <form action="login_dosen_act.php" method="post">
            <div class="panel panel-body login-form">
              <br/>
              <div class="text-center">
                <!-- <div class="icon-object border-warning-400 text-warning-400"><i class="icon-people"></i></div> -->
                <h5 class="content-group-lg">Login Form Dosen<br/>Aplikasi Manajemen Tugas Skripsi<br/></h5>
              </div>
