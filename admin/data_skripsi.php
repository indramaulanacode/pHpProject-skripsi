			...
			<div class="col-lg-12">
				...
				<div class="panel panel-flat">
					<div class="panel-heading">
						<h4 class="panel-title">Data Skripsi Mahasiswa</h4>
			                ...
			                <tr>
							  ...
							  <th>
			                    <select class="form-control" name="pilih_nama" id="pilih_nama">
									...
									<?php
									$data = mysqli_query($connect,"SELECT DISTINCT nama_mahasiswa FROM tbl_skripsi;");		
							...
							<thead>
								...
								<tbody>
									...
									if(isset($_GET['pilih_nama'])){
										...
										$data = mysqli_query($connect,"SELECT * FROM tbl_skripsi WHERE nama_mahasiswa ='$pilih'");	
										$no = 1;
										while($d=mysqli_fetch_array($data)){
											?>
										...
										<tr>
											...
											<td>
												...
												<a class="btn btn-success" btn-flat btn-icon btn-xs" href="kelola_skripsi.php?id=<?php echo $d['id'];?>">kelola</i></a>
